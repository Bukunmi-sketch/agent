...
public function loginSetStatusOnline($sessionid){
    $query="UPDATE agents SET Status='online' WHERE id=:sessionid ";
  ...
  public function lastActivity($sessionid,$activitytime,$activetime,$activedate,$datelastactivity){
   $query="UPDATE agents SET LastActivity=:activitytime, LastActiveTime=:activetime, LastActiveDate=:activedate,DateLastActivity=:datelastactivity WHERE id=:sessionid ";
   $stmt=$this->db->prepare($query);
   $stmt->bindParam(":sessionid", $sessionid);
 ...
 public function usersLogData($sessionid,$ipaddress,$browsertype){
    $query="UPDATE agents SET ip_address=:ipaddress, browser_type=:browser_type WHERE id=:sessionid ";
    $stmt=$this->db->prepare($query);
    $stmt->bindParam(":sessionid", $sessionid);
